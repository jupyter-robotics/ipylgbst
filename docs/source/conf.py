...
# -*- coding: utf-8 -*-
#
# ipylgbst documentation build configuration file
#
...
latex_documents = [
    (master_doc, 'ipylgbst.tex', 'ipylgbst Documentation',
     'Thorsten Beier', 'manual'),
]
